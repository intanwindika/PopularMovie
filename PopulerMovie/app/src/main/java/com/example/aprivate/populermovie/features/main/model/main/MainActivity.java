package com.example.aprivate.populermovie.features.main.model.main;
...
import com.example.aprivate.populermovie.data.api.TmdbService;
...
import com.example.aprivate.populermovie.features.main.model.detail.MovieDetailActivity;
import com.example.aprivate.populermovie.features.main.model.main.adapter.MainAdapter;
import com.example.aprivate.populermovie.features.main.model.main.contract.AddOrDeleteFavoriteMovieContract;
import com.example.aprivate.populermovie.features.main.model.main.contract.MainListItemClickListener;
import com.example.aprivate.populermovie.features.main.model.main.loader.FavoriteMovieListLoader;
...
import com.example.aprivate.populermovie.utils.converter.MovieDataToMainItemConverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int STATE_LATEST_MOVIE = 2;
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuId == R.id.action_popular) {
                    ...
                    currentState = STATE_LATEST_MOVIE;
    ...
    private void fetchLatestMovie() {
        ...
        hideMovieList();
        hideMessage();
        Call<MovieDataResponse> call = TmdbService.open().getLatestMovies(1);
        call.enqueue(new Callback<MovieDataResponse>() {
            @Override
            public void onResponse(Call<MovieDataResponse> call, Response<MovieDataResponse> response) {
                MovieDataResponse data = response.body();
